...
public:
	...
	void addProgressBar(byte action, lpctstr name, word durationSeconds = 0, byte direction = 1, lpctstr description = nullptr, byte style = 1, byte anchor = 1, word barHue = 0, byte timerMode = 0, dword durationMilliseconds = 0) const;
